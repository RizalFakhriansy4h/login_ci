    ...
    <div class="modal-content">
        ...
        <form action="<?= base_url('menu/submenu') ?>" method="post">
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="menu">Submenu For ?</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="url" name="url" placeholder="Add New Url">
                </div>
                <div class="form-group">
                    <label for="icon">Icon Name</label>
                    <input type="text" class="form-control" id="icon" name="icon" placeholder="Add New Icon">
                </div>
                <div class="form-group">
